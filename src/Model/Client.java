...
public class Client extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton3.setText("Modifier/supprimer");
        ...
        setSize(new java.awt.Dimension(611, 325));
...
try{
    Connecter();
    pst =(PreparedStatement) con.prepareStatement("insert into client(NumPermis,Nom,Prenom,Adress,numTel) value(?,?,?,?,?)");
...
e.printStackTrace();
    ...
    public void Table (){
        String [] Client={"NumPermis","Nom","Prenom","Adress","numTel"};
        ...
        try{
            ...
            while (rs.next()){
                ajouter[0]=rs.getString("NumPermis");
                ajouter[1]=rs.getString("Nom");
                ajouter[2]=rs.getString("Prenom");
                ajouter[3]=rs.getString("Adress");
                ajouter[4]=rs.getString("numTel"); 
